...
def getting_links(driver):
    ...
    while True:
        ...
        container = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//div[@class='jobs-section__inner']/div[@class='jobs-section__list']")))
        ...
        try:
            next_button = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, "//a[@class='next_page']")))
            next_button.click()
        except:
            print(f"Number of links get are : {(len(link_list))}")
            return link_list
...
def getting_values(driver, url):
    try:
        ...
        job_id = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//div[@class='page-copy job-details']//p"))
        )
        ...
        job_title = WebDriverWait(driver, 10).until(
            EC.presence_of_element_located((By.XPATH, "//div[@class='page-copy job-details']//h1"))
        )
        ...
        desc_content = soup.find("div", class_="job-details__content-description")
        ...
        jobDetails = {
            ...
            "Status": "",
            "Views": "",
            "Employer Email": "msh@mshsyneos.com",
            "Full Name": "",
            "Company Name": "Syneos",
            "Employer Website": "https://www.syneoshealth.com/",
            "Employer Phone": '1 866 262 7427',
            "Employer Logo": "https://connect.talemetry.com/system/production/assets/185098/original/Syneos_Health_rgb_r.png",
            "Company Description": "Syneos Health® is a leading fully integrated biopharmaceutical solutions organization built to accelerate customer success. We translate unique clinical, medical affairs and commercial insights into outcomes to address modern market realities.",
            "Status": "Active",
        }
...
def scraping():
    try:
        ...
        url = "https://www.syneoshealth.com/clinical-corporate-careers/jobs/search/?q=sales&location=United+States"
        driver.get(url)
        links = getting_links(driver)
        
        list_jobs = extracting_links(links, driver)
        if list_jobs:
            write_to_csv(list_jobs, "data", "Syneo.csv")
        else:
            pass

    ...
    for job in jobs:
        try:
            ...
            jobDetails = {
                ...
                "Status": "",
                "Views": "",
                "Employer Email": "msh@mshquidelortho.com",
                "Full Name": "",
                "Company Name": "QuidelOrtho",
                "Employer Website": "https://orthoclinical.wd1.myworkdayjobs.com/",
                "Employer Phone": "",
...
def scraping():
    try:
        ...
        url = "https://orthoclinical.wd1.myworkdayjobs.com/en-US/Search/jobs?q=sales&Country=bc33aa3152ec42d4995f4791a106ed09"
        try:
            driver.get(url)
            Jobs = getJobs(driver)
            write_to_csv(Jobs, "data", "QuidelOrtho.csv")
        except Exception as e:
            print(f"Error : {e}")
    except Exception as e:
